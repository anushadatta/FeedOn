...
function listAllMatches() {
    getMatch().then((matches) => {
        ...
        matches.forEach((match) => {
            ...
            contents.textContent = `${match.quantity} were delivered to people in need by the successful collaboration between ${match.restaurantName} and ${match.charityName}.`;
